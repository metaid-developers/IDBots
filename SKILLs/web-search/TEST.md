...
This guide walks through testing the entire Web Search Skill integration with IDBots.

## Prerequisites

1. IDBots built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with IDBots.

**Steps:**

1. Start IDBots in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of IDBots launch.
...
1. Open a terminal while IDBots is running
...
**Objective:** Verify graceful shutdown of services when IDBots quits.

**Steps:**

1. With IDBots running and searches completed, quit the application
...
1. Start IDBots (ensure headless is false in config)
...
- ✅ Server auto-starts with IDBots
