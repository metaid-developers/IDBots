...
export const buildRemoteSkillServiceUpsertStatement = (
  parsed: ParsedRemoteSkillServiceRow
): RemoteSkillServiceUpsertStatement => ({
  sql: REMOTE_SKILL_SERVICE_UPSERT_SQL,
  params: [
    parsed.id,
    parsed.pinId,
