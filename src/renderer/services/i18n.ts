...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    metabotAvatar: '头像',
    metabotAvatarPlaceholder: '头像 URL 或 Base64',
    metabotType: '类型',
    ...
    metabotLlmId: 'LLM 大脑 ID',
    metabotLlmIdPlaceholder: '可选',
    metabotTools: '工具',
  ...
  en: {
    ...
    metabotAvatarPlaceholder: 'Avatar URL or Base64',
    metabotType: 'Type',
    metabotTypeWorker: 'Worker',
    ...
    metabotLlmId: 'LLM brain ID',
    metabotLlmIdPlaceholder: 'Optional',
    metabotTools: 'Tools',
