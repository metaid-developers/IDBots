...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    gigSquarePublishExecutionReminderPlaceholder: '例如：如果用户没指定城市就用北京；如果用户有具体信息就以用户需求为准，并以用户需求语言回复',
    ...
    metabotAllowChatSkillsHint: '这些技能会写入 bio.allowChatSkills，供私聊流程读取。',
  ...
  en: {
    ...
    gigSquarePublishExecutionReminderPlaceholder: 'e.g. Use Beijing if no city is specified; follow the user request when details are provided, and reply in the user request language',
    ...
    metabotAllowChatSkillsHint: 'These skills are written to bio.allowChatSkills for the private-chat flow.',
