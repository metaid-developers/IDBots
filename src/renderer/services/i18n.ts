...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    metabotBossMetaId: 'BOSS MetaID',
    metabotBossMetaIdOptional: '(可选)',
    metabotBossMetaIdPlaceholder: '输入上级的 globalmetaid',
    metabotBossMetaIdHint: '填写后，该 MetaBot 将归属于指定的 MetaID 身份',
  ...
  en: {
    ...
    metabotBossMetaIdPlaceholder: 'Enter supervisor globalmetaid',
    metabotBossMetaIdHint: 'If set, this MetaBot will be associated with the specified MetaID identity',
